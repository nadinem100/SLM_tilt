#!/bin/bash
#SBATCH --job-name=slm_80x80_8um_10p_f2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Copy the original test file from fixed2 folder and modify parameters
cp fixed2/test_adaptive_gs.py test_adaptive_gs_temp.py
...
sed -i 's/SPACING_UM = .*/SPACING_UM = 8.0/' test_adaptive_gs_temp.py
...
echo "Grid: 80x80, Spacing: 8.0um, Tilt: -13deg"
