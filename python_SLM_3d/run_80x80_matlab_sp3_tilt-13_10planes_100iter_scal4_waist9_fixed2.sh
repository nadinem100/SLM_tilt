#!/bin/bash
#SBATCH --job-name=slm_80x80_sp3_10p_f2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
sed -i 's/SPACING_FACTOR = .*/SPACING_FACTOR = 3.0/' test_adaptive_gs_temp.py
...
echo "Grid: 80x80, MATLAB spacing_factor=3.0, Tilt: -13deg"
