#!/bin/bash
#SBATCH --job-name=slm_40x40_sp14.4
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
sed -i 's/N_HORIZ = .*/N_HORIZ = 40/' test_adaptive_gs_temp.py
sed -i 's/N_VERT = .*/N_VERT = 40/' test_adaptive_gs_temp.py
sed -i 's/SPACING_UM = .*/SPACING_UM = 14.4/' test_adaptive_gs_temp.py
...
echo "Grid: 40x40, Spacing: 14.4um, Tilt: -13deg"
