...
def main():
    ...
    # ========== SAVE RESULTS ==========
    print("\n--- Saving results ---")
    label = f"_adaptive_{N_HORIZ}x{N_VERT}_sp{SPACING_UM}um_tilt{TILT_ANGLE_X}deg_{N_Z_PLANES}planes_{ITERATIONS}iter_scal{SCAL}_waist{WAIST_UM/1e3*2:.1f}"
