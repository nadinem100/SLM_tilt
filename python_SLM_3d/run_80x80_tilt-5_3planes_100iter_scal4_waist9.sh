#!/bin/bash
#SBATCH --job-name=slm_80x80_tilt-5
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
sed -i 's/TILT_ANGLE_X = .*/TILT_ANGLE_X = -5  # degrees/' test_adaptive_gs_temp.py
...
echo "Grid: 80x80, Spacing: 7.2um, Tilt: -5deg"
echo "N_Z_PLANES=3, ITERATIONS=100, SCAL=4, WAIST=9.0"
