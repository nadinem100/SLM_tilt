#!/bin/bash
#SBATCH --job-name=slm_matlab_80x80_150
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
echo "MATLAB-style horizontal spacing - 80x80 (150 iter)"
echo "=========================================="
...
# Parameters: 80x80, MATLAB horizontal spacing, -13deg tilt, 150 iterations
N_Z_PLANES=10
ITERATIONS=150
SCAL=4
WAIST_COEFF=9.0
